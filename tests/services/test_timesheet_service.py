...
def test_build_daily_records_table():
    ...
    period_result.daily_results = {
        date(2023, 10, 1): mock_daily_1,
        date(2023, 10, 2): mock_daily_2
    }
    period_result.daily_is_holiday = {
        date(2023, 10, 1): True,
        date(2023, 10, 2): False
    }
    ...
    t = timesheet_service._build_daily_records_table(
        date(2023, 10, 1), date(2023, 10, 2), period_result, [holiday], data_table, t_style, table_text_style
    )
