...
def test_printer_service_get_by_id_success(mocker):
    ...
    mocker.patch("app.services.printer_service.printer_repository.get_by_id", return_value=mock_printer)
...
def test_printer_service_get_by_id_not_found(mocker):
    mock_db = MagicMock(spec=Session)
    mocker.patch("app.services.printer_service.printer_repository.get_by_id", return_value=None)
...
def test_printer_service_get_all(mocker):
    ...
    mocker.patch("app.services.printer_service.printer_repository.get_all", return_value=mock_printers)
...
def test_printer_service_create(mocker):
    ...
    mocker.patch("app.services.printer_service.printer_repository.create", return_value=mock_printer)
...
def test_printer_service_update(mocker):
    ...
    mocker.patch("app.services.printer_service.printer_repository.get_by_id", return_value=mock_printer)
    mocker.patch("app.services.printer_service.printer_repository.update", return_value=mock_printer)
...
def test_printer_service_delete(mocker):
    ...
    mock_printer = Printer(id=1, name="P1", address="192.168.1.10", company_id=1)
    mocker.patch("app.services.printer_service.printer_repository.get_by_id", return_value=mock_printer)
    mock_delete = mocker.patch("app.services.printer_service.printer_repository.delete")
