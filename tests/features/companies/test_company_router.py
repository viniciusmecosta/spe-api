...
def test_get_company_found(client: TestClient, mocker: MagicMock) -> None:
    ...
    mocker.patch.object(CompanyService, "get_company", return_value=mock_company)
...
def test_get_company_not_found(client: TestClient, mocker: MagicMock) -> None:
    mocker.patch.object(CompanyService, "get_company", return_value=None)
...
def test_create_company(client: TestClient, mocker: MagicMock) -> None:
    ...
    mocker.patch.object(CompanyService, "create_company", return_value=mock_company)
...
def test_update_company(client: TestClient, mocker: MagicMock) -> None:
    ...
    mocker.patch.object(CompanyService, "update_company", return_value=mock_company)
...
def test_upload_company_logo(client: TestClient, mocker: MagicMock) -> None:
    ...
    mocker.patch.object(CompanyService, "upload_logo", return_value=mock_company)
