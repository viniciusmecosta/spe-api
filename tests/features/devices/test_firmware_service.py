...
def test_upload_firmware_success(mock_copy, mock_file, mock_time, mock_audit, mock_repo, firmware_service,
                                 db_session_mock, mock_upload_file):
...
@patch("builtins.open", new_callable=mock_open)
@patch("shutil.copyfileobj")
def test_upload_firmware_latest_invalid_version(mock_copy, mock_file, mock_time, mock_repo, firmware_service,
                                                db_session_mock, mock_upload_file):
...
@patch("builtins.open", new_callable=mock_open)
@patch("shutil.copyfileobj")
def test_update_firmware_file_success(mock_copy, mock_file, mock_time, mock_audit, mock_repo, firmware_service,
                                      db_session_mock, mock_upload_file):
