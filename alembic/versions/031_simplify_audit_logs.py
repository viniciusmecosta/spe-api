...
def upgrade() -> None:
    ...
    audit_logs = conn.execute(sa.text("SELECT id, user_id, actor_id, details, reason, justification, target_user_id, actor_name, target_user_name, record_type, record_time, new_data FROM audit_logs")).fetchall()
