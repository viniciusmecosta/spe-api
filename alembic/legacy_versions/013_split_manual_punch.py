...
def upgrade() -> None:
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(
            sa.Column('can_manual_punch_desktop', sa.Boolean(), server_default=sa.true(), nullable=True))
        batch_op.add_column(
            sa.Column('can_manual_punch_mobile', sa.Boolean(), server_default=sa.false(), nullable=True))
